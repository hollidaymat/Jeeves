...
export const COMMAND_REGISTRY: Command[] = [
  ...
  {
    id: 'homelab.security_status',
    patterns: [
      /^(?:homelab\s+security\s+(?:status|report)?|infrastructure\s+security|machine\s+security|jeeves\s+security)$/i,
      /^security\s+(?:status|overview|dashboard|report)$/i,
    ],
    aliases: ['homelab security status', 'homelab security', 'infrastructure security', 'machine security', 'security report', 'security status'],
    action: 'homelab_security_status',
    examples: ['homelab security status', 'security report', 'security status', 'infrastructure security', 'machine security'],
    category: 'homelab',
  },
